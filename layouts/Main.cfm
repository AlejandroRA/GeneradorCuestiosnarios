        ...
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element">
                    <img alt="image" class="rounded-circle" src="/includes/img/profile_small.jpg"/>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-messages">
                    ...
                    <li>
                        <div class="dropdown-messages-box">
                            <a class="dropdown-item float-left" href="profile.html">
                                <img alt="image" class="rounded-circle" src="/includes/img/a4.jpg">
                            </a>
                            <div class="media-body ">
                    ...
                    <li>
                        <div class="dropdown-messages-box">
                            <a class="dropdown-item float-left" href="profile.html">
                                <img alt="image" class="rounded-circle" src="/includes/img/profile.jpg">
                            </a>
                            <div class="media-body ">
...
<!--- Barra de navegacion (referencia) --->
